		...
		<div class="row justify-content-between align-items-center">
				...
				<div class="modal fade" id="loginmodal" tabindex="-1" role="dialog">
						...
						<div class="modal-content">
							<form name="loginform" id="loginform" action="<?php echo esc_url( $Password_Protected->login_url() ); ?>" method="post">
								...
								<div class="modal-header">
									<h5 class="mdoal-title">Front-end Login</h5>
								...
								<div class="modal-body">
									<p>
										<label for="password_protected_pass">
											<?php _e( 'Password', 'password-protected' ) ?><br/>
					...
					-->
									...
									<p class="submit">
										<input type="submit" name="wp-submit" id="wp-submit" class="btn btn-primary" value="<?php esc_attr_e( 'Log In', 'password-protected' ); ?>" tabindex="100"/>
				...
				<div class="col-12 site-footer align-self-end text-center">
					<p>Authorized users can view changes <a href="" data-toggle="modal" data-target="#loginmodal">here</a></p>
				</div>
		</div>
	</div>
