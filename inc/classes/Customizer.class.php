...
*/
    ...
    public function add_breadcrumb_options_to_customizer( $wp_customize ) {
        ...
        $wp_customize->add_setting( 'bric_bc_location', [
            'default' => 'after_page_header',
            'transport' => 'refresh',
            'type' => 'theme_mod',
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'wp_filter_nohtml_kses'
        ...
        $wp_customize->add_control( 'bric_bc_location', [
            'label' => __( 'Breadcrumb Location' ),
            'description' => __( 'Where the breadcrumbs appear' ),
            'section' => 'wpseo_breadcrumbs_customizer_section',
            'priority' => 100,
            'type' => 'select',
            'capability' => 'edit_theme_options',
            'choices' => [ 
                'after_page_header' => __( 'After Heading'),
                'before_page_header'  => __( 'Before Heading'),
            ]
        ]);
     ...
     */
     ...
     public function compile_scss() {
        ...
        try {
            ...
            //$compiler->setOutputStyle( $compiler::COMPRESSED );

            $compiler->setSourceMap( $compiler::SOURCE_MAP_FILE );
            $compiler->setSourceMapOptions([
                'sourceMapURL' => './bric-style.map'
            ]); 
