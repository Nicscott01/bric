...
/**
 * Class Name: Bootstrap 5 Nav Walker
...
class Bootstrap5Navwalker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if (strcasecmp($item->title, 'divider') == 0) {
			...
			$attributes .= ($args->has_children) ? ' data-bs-toggle="dropdown" data-bs-target="#" class="' . $anchor_classes .' dropdown-toggle"' : ' class="' . $anchor_classes .'"';
