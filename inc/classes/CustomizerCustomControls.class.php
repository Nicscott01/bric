...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Skyrocket_Custom_Control extends WP_Customize_Control {
		...
		protected function get_skyrocket_resource_url() {
			...
			return trailingslashit( get_template_directory_uri() . '/assets' );
		}
	}
	...
	class Skyrocket_Google_Font_Select_Custom_Control extends Skyrocket_Custom_Control {
		...
		public function skyrocket_getGoogleFonts( $count = 30 ) {
            ...
            $fontFile = get_template_directory() . '/inc/google-fonts-alphabetical.json';
			
            
            if ( $this->fontOrderBy === 'popular' ) {

				$fontFile = get_template_directory() . '/inc/google-fonts-popularity.json';
...
*/
	 ...
	 * @link 
	 */
	class Bric_Font_Awesome_Select_Custom_Control extends Skyrocket_Google_Font_Select_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'font_awesome';
		/**
		 * The list of Font Awesome fonts
		 */
		private $fontList = false;
		/**
		 * The saved font values decoded from json
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->bric_getFontAwesomeFonts( 'all' );
		 ...
		 * Return the list of Google Fonts from our json file. Unless otherwise specfied, list will be limited to 30 fonts.
		 */
		public function bric_getFontAwesomeFonts( $count = 30 ) {

            

            $fontFile = get_template_directory() . '/inc/icons.json';
